...
export const Songbar = ({
  ...
  return (
    <div
      className={`bg-white ${isActive && "bg-gray-100"}  hover:bg-gray-100 rounded-lg shadow-md p-4 flex items-center space-x-4 transition-all duration-400 hover:cursor-pointer`}
      onClick={onAction}
    >
      <img
      ...
      />
      <div className="">
        <h3 className="text-sm font-semibold">{audio.heading}</h3>
        <p className="text-xs text-gray-600">{audio.subheading}</p>
      </div>
    </div>
  );
};
